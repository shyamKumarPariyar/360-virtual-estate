    ...
    return (
        <section id="cta" className="cta">
            <div className="wrap">
                ...
                <Reveal as="p" className="lead" delay={80} style={{ margin: "0 auto 1.6rem", textAlign: "center" }}>No headset needed to start — open a 360° tour in your browser and go from there.</Reveal>
